...
describe('Looking for patients and diseases in route /date', function () {
  ...
  it('/date/:name/:disease/:date_init/:date_final returns message saying that it did not find the information by the date entered when it does not find the data in this case', async function () {
